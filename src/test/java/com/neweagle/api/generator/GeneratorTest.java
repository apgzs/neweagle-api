package com.neweagle.api.generator;
...
public class  GeneratorTest{
    private static final String DB_URL="jdbc:mysql://127.0.0.1:3306/neweagle-api?characterEncoding=utf8";//数据库路径
    private static final String DB_USER="root";//数据库用户名
    private static final String DB_PASS="123123";//数据库密码

    private static final String OUTPUT="C://neweagle-code-gen";//输出路径

    private static final String AUTHOR="tjp";//作者

    private static final String MODULE="test";//模块名

    private static final String TABLE="n_sys_app_user";//表名
